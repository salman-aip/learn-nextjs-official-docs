...
export default function DashboardHome() {
  return (
    <div className="w-full h-[calc(100vh_-_80px)] bg-orange-600 text-center overflow-auto">
      ...
      <div id="A">
        ...
        sections 1.10.32 and 1.10.33 of Finibus Bonorum et Malorum (The Extremes of Good and Evil by
        ...
        a line in section 1.10.32. The standard chunk of Lorem Ipsum used since the 1500s is
      ...
      <div className="mt-8">
        <Link href="/" className="bg-white px-4 py-3" replace={false} prefetch={true}>
          Back to Home
        </Link>
      </div>
    </div>
